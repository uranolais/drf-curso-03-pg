...
class EstudanteViewSet(viewsets.ModelViewSet):
    ...
    Filter Backends:
    - DjangoFilterBackend: permite filtrar os resultados da consulta.
    - OrderingFilter: permite ordenar os resultados da consulta.
    - SearchFilter: permite pesquisar os resultados da consulta.
